                        ...
                        <div class="card col-md-12">
                            <div class="card-body col-md-12">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="welcome_log-tab" data-toggle="tab" href="#welcome_log" role="tab" aria-controls="welcome_log"
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade " id="welcome_log" role="tabpanel" aria-labelledby="welcome_log-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                            <div class="card-body">
                    ...
                    <div class="tab-pane fade" id="abandoned_cart" role="tabpanel" aria-labelledby="abandoned_cart-tab">
                        <div class="col-md-12 col-lg-12 card">
                            <div class="card-body col-md-12">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="abandonedcart_campaign-tab" data-toggle="tab" href="#abandonedcart_campaign" role="tab" aria-controls="abandonedcart_campaign"
                                           aria-selected="false">Abandoned Cart Sms Campaign</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="abandonedcart_log-tab" data-toggle="tab" href="#abandonedcart_log" role="tab" aria-controls="abandonedcart_log"
                                           aria-selected="false">Logs</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">

                                    <div class="tab-pane fade show active" id="abandonedcart_campaign" role="tabpanel" aria-labelledby="abandonedcart_campaign-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                    ...
                                    <div class="tab-pane fade " id="abandonedcart_log" role="tabpanel" aria-labelledby="abandonedcart_log-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                            <div class="card-body">
                                                <div id="product_append">
                                                    <div class="row px-3" style="overflow-x:auto;">
                    ...
                    <div class="tab-pane fade" id="order_confirmation_sms" role="tabpanel" aria-labelledby="order_confirmation_sms-tab">
                        <div class="col-md-12 col-lg-12 card">
                            <div class="card-body col-md-12">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="order_confirm_campaign-tab" data-toggle="tab" href="#order_confirm_campaign" role="tab" aria-controls="order_confirm_campaign"
                                           aria-selected="false">Orderconfirm Sms Campaign</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="orderconfirm_log-tab" data-toggle="tab" href="#orderconfirm_log" role="tab" aria-controls="orderconfirm_log"
                                           aria-selected="false">Logs</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">

                                    <div class="tab-pane fade show active" id="order_confirm_campaign" role="tabpanel" aria-labelledby="order_confirm_campaign-tab">
                                        <div class="col-md-12 col-lg-12 card">
                    ...
                    <div class="tab-pane fade" id="order_refund" role="tabpanel" aria-labelledby="order_refund-tab">
                        <div class="col-md-12 col-lg-12 card">
                            <div class="card-body col-md-12">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="order_refund_campaign-tab" data-toggle="tab" href="#order_refund_campaign" role="tab" aria-controls="order_refund_campaign"
                                           aria-selected="false">Orderrefund Sms Campaign</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="orderrefund_log-tab" data-toggle="tab" href="#orderrefund_log" role="tab" aria-controls="orderrefund_log"
                                           aria-selected="false">Logs</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">

                                    <div class="tab-pane fade show active" id="order_refund_campaign" role="tabpanel" aria-labelledby="order_refund_campaign-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                    ...
                                    <div class="tab-pane fade " id="orderrefund_log" role="tabpanel" aria-labelledby="orderrefund_log-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                            <div class="card-body">
                                                <div id="product_append">
                                                    <div class="row px-3" style="overflow-x:auto;">
                    ...
                    <div class="tab-pane fade" id="order_dispatch" role="tabpanel" aria-labelledby="order_dispatch-tab">
                        <div class="col-md-12 col-lg-12 card">
                            <div class="card-body col-md-12">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="order_dispatch_campaign-tab" data-toggle="tab" href="#order_dispatch_campaign" role="tab" aria-controls="order_dispatch_campaign"
                                           aria-selected="false">Orderdispatch Sms Campaign</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="orderdispatch_log-tab" data-toggle="tab" href="#orderdispatch_log" role="tab" aria-controls="orderdispatch_log"
                                           aria-selected="false">Logs</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">

                                    <div class="tab-pane fade show active" id="order_dispatch_campaign" role="tabpanel" aria-labelledby="order_dispatch_campaign-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                    ...
                                    <div class="tab-pane fade " id="orderdispatch_log" role="tabpanel" aria-labelledby="orderdispatch_log-tab">
                                        <div class="col-md-12 col-lg-12 card">
                                            <div class="card-body">
                                                <div id="product_append">
                                                    <div class="row px-3" style="overflow-x:auto;">
