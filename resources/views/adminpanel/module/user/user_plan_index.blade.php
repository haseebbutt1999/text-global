                    ...
                    <div class="card bg-white border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                ...
                                <li class="mt-2"><label>Buy Creadits:</label></li>
                                <li>
                                    @if(count($plan->credits))
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a style="margin-left: 1%; width: 50%;"    data-toggle="modal" data-target="#payment_modal{{$key}}" ><button type="button" class="btn btn-lg btn-block btn-outline-primary">Stripe</button></a>
                                            <a style="margin-left: 1%; width: 50%;"    data-toggle="modal" data-target="#paypal_payment_modal{{$key}}" ><button type="button" class="btn btn-lg btn-block btn-outline-primary">PayPal</button></a>
                                        </div>
                                    @else
                                    ...
                                    <div class="modal fade" id="paypal_payment_modal{{$key}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-popout" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-popout" role="document">
                                            <div class="modal-content">
...
{{--                                                @endif--}}
                                                <div class="block card p-3 block-themed block-transparent mb-0">
                                                    ...
                                                    <div class="block-content">
                                                        <form class="w3-container w3-display-middle w3-card-4 " method="POST" id="payment-form"  action="{{Route('paypal-payment')}}">
                                                            ...
                                                            <div class='form-group '>
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    @if(count($plan->credits))
                                                                        ...
                                                                        @foreach($plan->credits as $key2=>$credit_data)
                                                                            {{--                                                                        @dd($credit_data)--}}
                                                                            <label class="form-check-label d-flex payapal-price-redit-main-div">
                                                                                <input type="hidden"  name="amount" class="paypal-amount">
                                                                                <input type="hidden" name="paypal_credits" class="paypal-credits">
                                                                                <input class="paypal-form-radio-input" required type="radio" style="display: block !important;" name="radio[]" data-amount = "{{$credit_data->price}}" data-credits = "{{$credit_data->credits}}"  >
                                                                                <p class="ml-2">Credits {{$credit_data->credits}} / </p>
                                                                                <p class="mr-2"> {{ $credit_data->price}}£</p>
                                                                            </label>
                                                                        @endforeach
                                                            ...
                                                            <button class="w3-btn w3-blue btn-primary">Pay with PayPal</button></p>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="form-group d-flex">
                                <a style="width: 100%;" class="subscribe"  href="{{ route('billing', ['plan' => $plan->id]) }}" ><button type="button" class="btn btn-lg btn-block btn-outline-primary">Subscribe</button></a>
                            </div>
