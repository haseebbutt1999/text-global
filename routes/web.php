...
Route::group(['middleware' => ['auth.shopify', 'shop-active']], function () {
    ...
    Route::get('/customer-export', 'AdminController@customer_export')->name('customer-export');
    Route::get('/customer-push', 'AdminController@customer_push')->name('customer-push');
...
//        Route::get('/orderconfirm-campaign-save', 'UserController@orderconfirm_campaign')->name('orderconfirm-campaign-save');
    ...
    Route::get('status/{credits}/{amount}', 'PaymentController@getPaymentStatus')->name('status');
